           ...
           {{--      <div class="bg-white bg-opacity-25 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 p-6 lg:p-8">
                    <div class="pb-4 md:border-r border-gray-400">
                        <div class="flex items-center">
                            ...
                            <h2 class="ml-3 text-xl font-semibold text-gray-900">
                                <a class="btnClick cursor-pointer hover:text-red-600">Lista Agenda</a><button class="ml-4 border border-gray-300 px-2 h-6 rounded hover:bg-red-200 text-xs listarAgenda">Listar</button>
                            </h2>
                        </div>
                ...
                <script>
                    ...
                    $( ".listarAgenda" ).on( "click", function()
                    {
                        ...
                        $.ajax(
                        {
                             url: '{{ route('nueva-agenda', array('ruta' => 'agenda','page' => 'listar' )) }}',
                             type: 'GET',
                             async: true,
                    ...
                    // $(document).on('click', '.listarAgenda', function () {
                    //     event.preventDefault();
                    //     $.ajax(
                    //     {
                    //          url: 'listar',
