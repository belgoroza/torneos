            ...
            <form id="formAddEditOrganizacion" class="forms-sample" id="addEditOrganizacion"
                ...
                <div class="grid grid-cols-2">
                    <div class="border-b border-gray-300 mr-2 col-span-2">
                        ...
                        <span class="w-full appearance-none bg-transparent border-none w-full text-gray-500 text-sm mr-3 py-1 px-2 leading-tight focus:outline-none">{{$organizacion->nombre}}</span>
                    </div>
