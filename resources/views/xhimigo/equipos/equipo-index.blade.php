                        ...
                        <div>
                            <div class="flex border-b border-teal-500 mr-2 ml-1 justify-between pb-2" >{{-- ROW 1 --}}
                                ...
                                <x-ss_componente.ss_menu>
                                    ...
                                    <x-slot name="content">
                                        <x-ss_componente.link href="{{ url('my-equipo/1/MKS11180') }}" data-modal="Lista de Equipos">
                                        ...
                                        <x-ss_componente.link onclick="nuevoEquipo()"  data-modal="Agregar Nuevo Equipo">
                                            ...
                                            </svg><span class="pl-2 ">Nuevo Equipo</span>
                                        </x-ss_componente.link>
                                    </x-slot>
                                </x-ss_componente.ss_menu>
								...
								@forelse($data as $organizacion)
									<div class="container bg-white rounded-xl shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
                                        <div class="row absolute top-2 right-2">
                                            <x-ss_componente.ss_menu_card>
                                                ...
                                                <x-slot name="content">
                                                    ...
                                                    <x-ss_componente.link-modal onclick="nuevoEquipo()">
                                        ...
                                        <div class="row">
									    	...
									    	<div class="flex items-center w-full h-12 bg-gray-200 absolute top-32"><span class="text-xs text-teal-600 font-bold mx-auto">{{$organizacion['organizacion']}}</span></div>
										</div>
									    <div class="flex pt-8 pb-2 justify-between px-2 border-b border-gray-100"><span class="text-gray-500 text-xs"> Código : </span> <span class="px-2 text-teal-600 text-xs font-bold">{{$organizacion['codigo']}}</span></div>
									    <div class="flex justify-between p-2 border-t border-gray-100">
									    	<span class="border border-gray-400 rounded px-1 cursor-pointer hover:text-red-500 hover:bg-gray-100 hover:border-red-300 openModal" data-id="{{$organizacion['id']}}"><i class="fas fa-play"></i></span>
