								...
								@forelse($data as $misTorneos)
									...
									<div class="container bg-white rounded-xl shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
										...
										<div class="row">
									    	...
									    	<div class="flex items-center w-full h-12 bg-gray-200 absolute top-32"><span class="text-xs text-teal-600 font-bold mx-auto">{{$misTorneos['nombre']}}</span></div>
										</div>

									    <div class="flex pt-8 pb-2 justify-between px-2 border-b border-gray-100"><span class="text-gray-500 text-xs"> Código : </span> <span class="px-2 text-teal-600 text-xs font-bold">{{$misTorneos['codigo']}}</span></div>
									    ...
									    <div class="flex justify-between p-2 border-t border-gray-100">
									    	<span class="border border-gray-400 rounded px-1 cursor-pointer hover:text-red-500 hover:bg-gray-100 hover:border-red-300 openModal" data-id="{{$misTorneos['id']}}">
