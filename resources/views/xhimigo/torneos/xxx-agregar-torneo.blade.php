        ...
        <div class="w-full md:w-2/3 flex flex-col space-y-2 p-3">
            ...
            <div class="grid grid-cols-2">
                ...
                <div class="border-b border-gray-300 mr-2 col-span-2">
                    ...
                    <input type="text" id="txt_nombre" class="w-full appearance-none bg-transparent border-none w-full text-gray-500 text-sm mr-3 py-1 px-2 leading-tight focus:outline-none">
                </div>

                <div class="border-b border-gray-300 mr-2 col-span-2">
                    <small class="text-xs text-gray-400">Nombre del Torneo (Adicional)</small><br>
                    <input type="text" id="txt_nombre_2" class="w-full appearance-none bg-transparent border-none w-full text-gray-500 text-sm mr-3 py-1 px-2 leading-tight focus:outline-none">
                </div>

                <div class="border-b border-gray-300 mr-2 pt-2">
                    <small class="text-xs text-gray-400">Disciplina:</small><br>
                    <input type="text" id="txt_disciplina" class="w-full appearance-none bg-transparent border-none w-full text-gray-500 text-sm mr-3 py-1 px-2 leading-tight focus:outline-none" value="FUTBOL">
                </div>
                ...
                <div class="border-b border-gray-300 mr-2 pt-2">
                    ...
                    <input type="date" id="txt_fecha_inicio" class="w-full appearance-none bg-transparent border-none w-full text-gray-500 text-sm mr-3 py-1 px-2 leading-tight focus:outline-none">
                </div>
                <div class="border-b border-gray-300 pt-2">
                    <small class="text-xs text-gray-400">Fecha de Finalización</small><br>
                    <input type="date" id="txt_fecha_fin" class="w-full appearance-none bg-transparent border-none w-full text-gray-500 text-sm mr-3 py-1 px-2 leading-tight focus:outline-none">
                </div>
