                        ...
                        <div class="flex w-full px-1 justify-between pb-2">{{-- ROW 2 --}}
                            <form class="w-full mr-1">
                              <div class="flex items-center border-b border-teal-500 py-1">
                                <input class="focus:outline-none appearance-none bg-transparent border-none focus:border-none w-full text-xs font-bold text-gray-700 mr-3 py-1 px-2 leading-tight " type="number" placeholder="Buscar..." aria-label="Full name" id="txtSearch">
                                ...
                                <span class="fas fa-plus border border-teal-400 text-teal-400 rounded p-1 cursor-pointer hover:bg-teal-400 hover:text-white" onclick="addPersona('')"></span>
                              </div>
                            </form>
                        </div>
